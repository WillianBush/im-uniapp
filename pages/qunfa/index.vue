<template>
	<view style="background-color: white;">
		<cu-custom bgColor="bg-blue" :isBack="true">
			<block slot="content">群发助手</block>
		</cu-custom>
		<scroll-view :scroll-y="true" style="color: #000;height:  calc(100vh - 220px);overflow: auto;padding-left: 25px;">
		...
		<view class="cu-bar foot input" :style="[{bottom:InputBottom+'upx'}]"
			style="flex-direction: row;height:180px; width: 100%;background-color: #fff;">
		...
		<view v-show="showItem==1" class="cu-bar foot "
			style="box-shadow: none;-webkit-box-shadow: none;display: block;background: #fff;height:330upx;margin-bottom:80upx;width: 100%;">
			...
			<view
				style="width:100%;height:80upx;background: #f6f6f6;border-top:1px solid #eee;bottom:0;position: fixed;display: flex;cursor:pointer">
		...
		<view   class="cu-modal"  v-if="showSendDialog" :class="showSendDialog?'show':''">
			<view  class="cu-dialog">
				<view>分别发送给：</view>
				<scroll-view :scroll-x="true" style="height: 80px;margin-top: 10px;margin-left: 10px;">
				...
				<view style="margin: 20px;">
					<button class="cu-btn shadow-blur round" @click="showSendDialog = false">取 消</button>
					<button class="cu-btn bg-gradual-green shadow-blur round" style="margin-left: 20px;" @click="sendQunfa()">发送({{checkItems.length}})</button>
				</view>
			</view>
		</view>
	</view>
