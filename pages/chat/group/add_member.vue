<template>
	<view>
		<view style="height: 45px;line-height: 45px;background: #eee;padding-left: 5px; color:#000">
			...
			邀请群成员
			<text @tap="tijiao()" style="float:right;font-size: 30upx;color: #000; margin-right: 10px;cursor: pointer;"
			...
			friend_list() {
				...
				nlist = nlist.filter((item) => {
					let l = item.list.filter((item1) => {
						...
						if (_this.curChatEntity) {
							const memberIdsArr = _this.curChatEntity.member_ids || [];
