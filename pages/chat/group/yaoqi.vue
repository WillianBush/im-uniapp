<template>
	<view>
		<cu-custom bgColor="bg-blue" :isBack="true" :nameToLeft="true">
			<block slot="content">邀请加入群组</block>
			<block slot="right">
				<uni-text @tap="tijiao()"
    ...
    line-height: 100upx;
    colo
import { yaoqiJoinRoom } from '../../../common/api';r: #999;" v-if="friend_list.length<=0">
				暂无可转发的对象
			</view>
		</scroll-view>
	...
	export default {
		...
		methods: {
			...
			tijiao() {
				...
				let ss = _this.temp.content.split("#");
				let v = {
