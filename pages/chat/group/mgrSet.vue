<template>
    ...
    margin-top: 10px!important;" class="cu-list menu">
			...
			<view v-if="user.id==curChatEntity.owner_UUID" @tap="goAddRoomMgr()" class="cu-item cu-form-group  arrow">
				<view class="content">
			...
			<view v-if="user.id==curChatEntity.owner_UUID" class="cu-item margin-top" style="" @tap="dissolveGroup()">
