	...
	<view class="forget" style="background: #fff;height:100vh">
		...
		<view class="content">
			...
			<view class="main" style="margin-top:40upx; align-items: center;">
				...
				<el-input v-model="oldPassData" type="text" maxlength="25" placeholder="请输入当前密码"
					style="margin-top:30px;margin-bottom:30px"></el-input>
				<el-input v-model="passData" type="password" maxlength="25" placeholder="请输入新密码" isShowPass></el-input>
